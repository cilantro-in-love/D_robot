...
class VrDateInterface:
    ...
    def process_robot_data(self, robot_pos):
        ...
        z = z - math.sin(wrist_flex* math.pi / 180)*l4
        r_distance = r_distance - math.cos(wrist_flex* math.pi / 180)*l4
    ...
    def process_vr_data(self):
        ...
        if left_goal.metadata and 'trigger' in left_goal.metadata:
            if left_goal.metadata['trigger'] > 0.5:
                self.target_gripper = 2500  # 张开
            else:
                self.target_gripper = 1300  # 闭合
        return robot_pos
    ...
    def main(self):
        ...
        while True:
            ...
            motors_bus1.write("Goal_Position", [2048+robot_angel_base,2048-robot_angel_shouder,2048+robot_angel_elbow,
                                                2048-robot_angel_flex,2048-robot_angel_roll,self.target_gripper])
            time.sleep(0.01)
